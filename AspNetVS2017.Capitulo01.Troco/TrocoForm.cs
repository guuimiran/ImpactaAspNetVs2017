...
namespace AspNetVS2017.Capitulo01.Troco
{
    public partial class TrocoForm : Form
    {
        ...
        private void btnCaicular_Click(object sender, EventArgs e)
        {
            var Pago = Convert.ToDecimal(txtValorPago.Text);
            var Compra = Convert.ToDecimal(txtValorCompra.Text);
            var Troco = Pago - Compra;

            decimal troco = Convert.ToDecimal(Pago - Compra);

            txtValorTroco.Text = Troco.ToString("c");
